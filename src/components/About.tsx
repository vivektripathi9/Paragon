...
const stats = [
  {
    ...
    value: (
      <>
        <span className="max-[1200px]:whitespace-nowrap">$50</span>
        <span className="hidden min-[1200px]:inline"> </span>
        <br className="min-[1200px]:hidden" />
        <span className="max-[1200px]:whitespace-nowrap">Billion+</span>
      </>
    ),
    description: (
      <>
        ...
        <span className="about-stat-description__locked hidden md:max-[1200px]:!block">
          <span className="block whitespace-nowrap">
            Paragon principals{"\u2019"}
          </span>
          <span className="block whitespace-nowrap">
        ...
        <span className="about-stat-description__mobile md:hidden">
          <span className="block whitespace-nowrap">
            Paragon principals{"\u2019"}
          </span>
          <span className="block whitespace-nowrap">
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <span className="md:hidden">Defeasance transactions completed</span>
      </>
    ),
      ...
      <div className="about-content-shell relative z-0 mx-auto flex w-full max-w-[1440px] flex-col px-[var(--about-inline-padding)] pb-[calc(var(--section-edge-height)+2.5rem)] pt-[calc(var(--section-edge-height)+var(--section-edge-seam)+54px)] max-md:max-w-[402px] max-md:pb-[calc(var(--section-edge-height)+4rem)] max-md:pt-[calc(var(--section-edge-height)+var(--section-edge-seam)+4rem)] md:max-[1439px]:max-w-[min(100%,75rem)] min-[1440px]:px-10">
        <div className="shrink-0 min-[1440px]:pl-2">
          ...
          <p className="about-lede font-heading w-full max-w-[1081px] text-[48px] font-medium leading-[68px] tracking-[-2px] max-md:h-auto max-md:max-w-[362px] max-md:text-[28px] max-md:leading-[42px] max-md:tracking-[-1.5px] md:max-[1439px]:h-auto md:max-[1439px]:max-w-[min(56rem,100%)] md:max-[1439px]:text-[clamp(2rem,3.75vw,3rem)] md:max-[1439px]:leading-[clamp(2.75rem,5.2vw,3.5rem)] md:max-[1439px]:tracking-[-1.75px] min-[1200px]:!font-medium min-[1440px]:min-h-[204px]">
            <span className="about-lede__desktop hidden min-[1200px]:!block">
            ...
            <span className="about-lede__tablet hidden md:max-[1200px]:!block">
              <span className="block whitespace-nowrap">
                <span className="text-paragon-muted">
                  Paragon is the only independent defeasance
                </span>{" "}
                <span className="text-paragon-navy">consultant</span>
              </span>
              <span className="block whitespace-nowrap text-paragon-navy">
                recommended by two of the nation&apos;s four largest CMBS
              </span>
              <span className="block whitespace-nowrap text-paragon-navy">
                servicers
              </span>
