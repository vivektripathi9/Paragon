    ...
    <section className="full-bleed relative h-[894px] overflow-hidden bg-[#04143c] max-lg:h-[852px]">
      ...
      <div className="relative z-10 mx-auto h-full w-full max-w-[1440px] max-lg:flex max-lg:max-w-[402px] max-lg:flex-col max-lg:justify-between max-lg:px-[21px] max-lg:pb-20 max-lg:pt-20 lg:px-0 lg:pt-0">
        <div className="lg:pl-12 lg:pt-36">
          ...
          <h1 className="font-heading h-[210px] w-full max-w-[737px] text-[62px] font-medium leading-[73px] tracking-[-3px] text-white max-lg:h-[188px] max-lg:max-w-[360px] max-lg:text-[40px] max-lg:leading-[47px] max-lg:tracking-[-1.5px]">
        ...
        <div className="absolute left-12 top-[579px] flex h-[120px] w-[1352px] flex-row items-center justify-between max-lg:static max-lg:h-auto max-lg:w-full max-lg:flex-col max-lg:gap-6">
          <p className="h-[120px] w-full max-w-[709px] shrink-0 font-sans text-[18px] font-medium leading-[30px] tracking-[-0.25px] text-[#FFFFFFCC] max-lg:h-[182px] max-lg:max-w-[362px] max-lg:text-[15px] max-lg:leading-[26px]">
          ...
          <div className="flex shrink-0 flex-row items-center gap-4 max-lg:w-full max-lg:max-w-[362px] max-lg:flex-col">
            <Link
              href="/calculator"
