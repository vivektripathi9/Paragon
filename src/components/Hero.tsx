...
export default function Hero() {
  return (
    <section className="hero-bg-color full-bleed relative h-[894px] overflow-hidden max-md:h-[852px] md:max-[1194px]:h-[clamp(760px,88vh,860px)]">
      ...
      <div className="hero-content-shell relative z-10 mx-auto h-full w-full max-w-[1440px] max-md:flex max-md:max-w-[402px] max-md:flex-col max-md:justify-between max-md:px-[var(--hero-inline-padding)] max-md:pb-20 max-md:pt-20 md:block md:max-w-[1194px] md:px-0 md:pb-0 md:pt-0 min-[1195px]:px-12">
        <div className="max-md:hidden px-[var(--hero-inline-padding)] pt-24 min-[1195px]:px-0 min-[1195px]:pt-36">
          <div className="hero-enter hero-enter--1 font-subheading mb-5 flex items-center gap-2.5 text-sm font-medium text-white/80 min-[1195px]:-ml-20 min-[1195px]:mb-8 min-[1195px]:text-base">
            <SectionLabelIcon variant="dark" />
            <span>Paragon Loan Advisors</span>
          </div>

          <h1 className="hero-enter hero-enter--2 font-heading h-auto w-full max-w-[clamp(30rem,52vw,42rem)] text-[clamp(3.125rem,4.6vw,3.875rem)] font-medium leading-[clamp(3.6rem,5.2vw,4.5rem)] tracking-[-0.14em] text-white min-[1195px]:-ml-20 min-[1195px]:max-w-[737px] min-[1195px]:text-[62px] min-[1195px]:leading-[73px] min-[1195px]:tracking-[-3px]">
        ...
        <div className="absolute top-[clamp(26rem,62%,34rem)] flex h-auto w-full flex-row items-center justify-between gap-[clamp(1.5rem,3vw,2.5rem)] max-md:static max-md:h-auto max-md:w-full max-md:flex-col max-md:gap-8 md:left-[var(--hero-inline-padding)] md:right-[var(--hero-inline-padding)] md:w-auto min-[1195px]:inset-x-0 min-[1195px]:top-[579px] min-[1195px]:h-[120px] min-[1195px]:w-full min-[1195px]:justify-between min-[1195px]:gap-16 min-[1195px]:px-0">
          <p className="hero-enter hero-enter--3 min-w-0 flex-1 font-sans text-[clamp(1rem,1.45vw,1.125rem)] font-medium leading-[clamp(1.75rem,2.55vw,1.95rem)] tracking-[-0.25px] text-[#FFFFFFCC] max-md:h-[182px] max-md:max-w-[362px] max-md:flex-none max-md:text-[15px] max-md:leading-[26px] md:max-w-[min(640px,46%)] min-[1195px]:-ml-30 min-[1195px]:h-[120px] min-[1195px]:max-w-[min(709px,48%)] min-[1195px]:text-[18px] min-[1195px]:leading-[30px] min-[1195px]:max-[1441px]:max-w-[min(640px,46%)]">
          ...
          <div className="hero-enter hero-enter--4 flex shrink-0 flex-row items-center gap-[clamp(0.75rem,1.25vw,1rem)] max-md:w-full max-md:max-w-[362px] max-md:flex-col md:max-[1194px]:flex min-[1195px]:flex min-[1195px]:translate-x-24">
            <Link
              href="/calculator"
