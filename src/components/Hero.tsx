  ...
  return (
    <section className="hero-bg-color full-bleed relative h-[894px] overflow-hidden max-md:h-[852px] md:max-[1194px]:h-[clamp(760px,88vh,860px)]">
      ...
      <div className="max-md:hidden px-[var(--hero-inline-padding)] pt-24 min-[1195px]:pt-36 min-[1440px]:px-0">
          <div className="hero-enter hero-enter--1 font-subheading mb-5 flex items-center gap-2.5 text-sm font-medium text-white/80 min-[1440px]:-ml-20 min-[1440px]:mb-8 min-[1195px]:text-base">
            <SectionLabelIcon variant="dark" />
            <span>Paragon Loan Advisors</span>
          </div>

          <h1 className="hero-enter hero-enter--2 font-heading h-auto w-full max-w-[clamp(30rem,52vw,42rem)] text-[clamp(3.125rem,4.6vw,3.875rem)] font-medium leading-[clamp(3.6rem,5.2vw,4.5rem)] tracking-[-0.14em] text-white min-[1440px]:-ml-20 min-[1195px]:max-w-[737px] min-[1195px]:text-[62px] min-[1195px]:leading-[73px] min-[1195px]:tracking-[-3px]">
