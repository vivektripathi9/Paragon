...
function NavLink({
  ...
  return (
    ...
    >
      ...
      <span className="col-start-1 row-start-1 font-normal group-hover:font-semibold">
        {label}
      </span>
    </Link>
  );
    ...
    <header className="absolute inset-x-0 top-0 z-50 bg-transparent pt-[env(safe-area-inset-top)]">
      ...
      >
        ...
        <div className="flex items-center gap-3 sm:gap-4 lg:gap-10 min-[1195px]:max-[1439px]:!gap-6">
          ...
          <Link
            href="/calculator"
            className="bg-calculator-btn relative z-[60] hidden shrink-0 bg-white px-7 py-2.5 text-[16px] font-semibold leading-[18.2px] tracking-[-0.5px] text-black transition-colors hover:bg-[#D9D9D9] md:max-lg:inline-flex lg:inline-flex lg:px-6 min-[1195px]:max-[1439px]:!px-5"
          >
            Calculator
          </Link>
